...
export default async function HomePage() {
  ...
  return (
    <main className='bg-background text-foreground font-sans min-h-screen transition-colors duration-300'>
      ...
      <div className='max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6'>
          ...
          <div className='space-y-4 sm:space-y-6'>
            ...
            <div className='bg-card backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg border border-border hover:shadow-xl transition-all duration-300 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6'>
              ...
              <div className='relative flex-shrink-0'>
                ...
                />
                <div className='w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-green-400 to-green-500 rounded-full border-2 border-background flex items-center justify-center'>
              ...
              <div className='flex-1 text-center sm:text-left'>
                ...
                <div className='flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center sm:justify-start'>
                  <div className='bg-secondary border border-border px-3 py-2 rounded-xl flex items-center gap-2 justify-center sm:justify-start hover:bg-accent transition-colors'>
