...
const RecordHistory = async () => {
  ...
  if (error) {
    return (
      <div className='bg-card backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-border'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
          ...
          <div>
            <h3 className='text-lg sm:text-xl font-bold bg-gradient-to-r from-card-foreground to-muted-foreground bg-clip-text text-transparent'>
              Expense History
            </h3>
